...
With the additive method, the seasonality is expressed in absolute terms in the scale of the observed time series. The seasonal component in each year will sum up to zero. With the multiplicative method, the seasonal component are expressed in relative terms. The seasonal component in each year will sum up to m(frequency).
